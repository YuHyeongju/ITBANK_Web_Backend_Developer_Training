...
public class Ex01 {
		...
		// 프로제트 우클릭 - 맨 아래 속성(properties)
	public static void main(String[] args) throws Exception {
			
		String  username = "hr";
		String  password = "hr";
		String url = "jdbc:oracle:thin:@192.168.1.100:1521:xe"; // DB접속주소
		...
		// 연결 상태를 확인하고, 상태가 정상이면 명령어를 전달할 준비를 수행함.
		stmt = (Statement)conn.createStatement();
		
		// DB에 전달할 명령어를 문자열 형태로 준비함.
