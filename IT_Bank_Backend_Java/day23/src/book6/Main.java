...
// case2 입력부분 , Scanner를 매개변수로 전달받아서 객체를 생성하고, 그 객체를 반환하는 함수.	

	static BookDTO getBookFromuserInput(Scanner sc) { // 나중에 이 부분은 화면으로 바뀔 것이기 떄문에
		BookDTO book = new BookDTO(); 				  // handler로 보낸 것들은 화면에 보이지 않는
