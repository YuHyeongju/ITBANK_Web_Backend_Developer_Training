	...
	<main>
	 ...
	 <details>
	 	...
	 	<ol>
	 		...
	 		<li>스프링에서느 컨트롤러 -> 서비스 -> DAO 형태의 연결이 거의 고정이므로, 미리 작성해 둔다.</li>
	 		<li>파일 업로드 등, 필요한 스프링 빈이 있으면 추가로 등록한다.</li>
	 		<li>단, 로그인 인터셉터는 기능 구현아 모두 끝난 후 마지막에 추가하여 테스트한다.</li>
	 		<li>대문페이지에서의 기능에 대한 링크(주소)가 만들어지면, 그에 대한 함수를 작성한다.</li>
