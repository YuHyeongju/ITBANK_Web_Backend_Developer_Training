...
<div style="display: flex; flex-flow: wrap; width: 800px;  margin:auto;">
	<c:forEach var="dto" items="${list }">
		<div class="item" style="margin:10px; text-align: center; width: 300px; background-color: aqua;">
			<p><img src="${cpath }/upload/${dto.storedFileName}" width = 250px;></p>
